...
import io.afu.aitaskservice.components.ApiLog;
...
import io.afu.aitaskservice.pojo.business.vo.douyin.Admire_auth;
import io.afu.aitaskservice.pojo.business.vo.douyin.Ancestor_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Anchor_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.App;
import io.afu.aitaskservice.pojo.business.vo.douyin.Author;
import io.afu.aitaskservice.pojo.business.vo.douyin.Avatar_large;
import io.afu.aitaskservice.pojo.business.vo.douyin.Avatar_medium;
import io.afu.aitaskservice.pojo.business.vo.douyin.Avatar_thumb;
import io.afu.aitaskservice.pojo.business.vo.douyin.Aweme_control;
import io.afu.aitaskservice.pojo.business.vo.douyin.Aweme_detail;
import io.afu.aitaskservice.pojo.business.vo.douyin.Big_thumbs;
import io.afu.aitaskservice.pojo.business.vo.douyin.Bit_rate;
import io.afu.aitaskservice.pojo.business.vo.douyin.Comment_permission_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Comment_words_recommend;
import io.afu.aitaskservice.pojo.business.vo.douyin.CommonContext;
import io.afu.aitaskservice.pojo.business.vo.douyin.Cover;
import io.afu.aitaskservice.pojo.business.vo.douyin.Cover_hd;
import io.afu.aitaskservice.pojo.business.vo.douyin.Cover_large;
import io.afu.aitaskservice.pojo.business.vo.douyin.Cover_medium;
import io.afu.aitaskservice.pojo.business.vo.douyin.Cover_original_scale;
import io.afu.aitaskservice.pojo.business.vo.douyin.Distribute_circle;
import io.afu.aitaskservice.pojo.business.vo.douyin.DouyinBean;
import io.afu.aitaskservice.pojo.business.vo.douyin.DouyinVideoDataVO;
import io.afu.aitaskservice.pojo.business.vo.douyin.Download_addr;
import io.afu.aitaskservice.pojo.business.vo.douyin.Download_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Download_suffix_logo_addr;
import io.afu.aitaskservice.pojo.business.vo.douyin.Duet_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Dynamic_cover;
import io.afu.aitaskservice.pojo.business.vo.douyin.Entertainment_product_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Extra;
import io.afu.aitaskservice.pojo.business.vo.douyin.Fail_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Fall_card_struct;
import io.afu.aitaskservice.pojo.business.vo.douyin.Feed_comment_config;
import io.afu.aitaskservice.pojo.business.vo.douyin.Friend_recommend_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Guide_scene_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Icon;
import io.afu.aitaskservice.pojo.business.vo.douyin.Image_album_music_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Image_comment;
import io.afu.aitaskservice.pojo.business.vo.douyin.Impression_data;
import io.afu.aitaskservice.pojo.business.vo.douyin.Item_list;
import io.afu.aitaskservice.pojo.business.vo.douyin.Item_warn_notification;
import io.afu.aitaskservice.pojo.business.vo.douyin.Limit_free;
import io.afu.aitaskservice.pojo.business.vo.douyin.Log_pb;
import io.afu.aitaskservice.pojo.business.vo.douyin.Market_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Music;
import io.afu.aitaskservice.pojo.business.vo.douyin.Origin_cover;
import io.afu.aitaskservice.pojo.business.vo.douyin.Photo_search_entrance;
import io.afu.aitaskservice.pojo.business.vo.douyin.Play_addr;
import io.afu.aitaskservice.pojo.business.vo.douyin.Play_addr_265;
import io.afu.aitaskservice.pojo.business.vo.douyin.Play_addr_h264;
import io.afu.aitaskservice.pojo.business.vo.douyin.Play_url;
import io.afu.aitaskservice.pojo.business.vo.douyin.Query;
import io.afu.aitaskservice.pojo.business.vo.douyin.Review_result;
import io.afu.aitaskservice.pojo.business.vo.douyin.Risk_infos;
import io.afu.aitaskservice.pojo.business.vo.douyin.Search_impr;
import io.afu.aitaskservice.pojo.business.vo.douyin.Series_paid_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Share_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Share_qrcode_url;
import io.afu.aitaskservice.pojo.business.vo.douyin.Show_follow_button;
import io.afu.aitaskservice.pojo.business.vo.douyin.Statistics;
import io.afu.aitaskservice.pojo.business.vo.douyin.Status;
import io.afu.aitaskservice.pojo.business.vo.douyin.Style_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Suggest_words;
import io.afu.aitaskservice.pojo.business.vo.douyin.Text_extra;
import io.afu.aitaskservice.pojo.business.vo.douyin.Video;
import io.afu.aitaskservice.pojo.business.vo.douyin.VideoInfoRes;
import io.afu.aitaskservice.pojo.business.vo.douyin.Video_control;
import io.afu.aitaskservice.pojo.business.vo.douyin.Video_game_data_channel_config;
import io.afu.aitaskservice.pojo.business.vo.douyin.Video_tag;
import io.afu.aitaskservice.pojo.business.vo.douyin.Visual_search_info;
import io.afu.aitaskservice.pojo.business.vo.douyin.Words;
import io.afu.aitaskservice.pojo.business.vo.douyin.Xigua_base_info;
import io.afu.aitaskservice.pojo.business.vo.wx.WxCode2SessionResp;
import io.afu.aitaskservice.pojo.business.vo.wx.WxCommonResp;
...
public class ReflectionHintsConfig {
    ...
    public static class ReflectionHintsConfigRuntimeHints implements RuntimeHintsRegistrar {
        ...
        public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
            ...
            hints.reflection().registerType(io.afu.aitaskservice.pojo.business.dto.AllowIPPortDTO.class,MemberCategory.values());
            hints.reflection().registerType(io.afu.aitaskservice.pojo.sys.dto.CommonBody.class,MemberCategory.values());
